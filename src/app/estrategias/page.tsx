...
export default function EstrategiasPage() {
  ...
  const loadContent = async () => {
    try {
      ...
      // Obtener la página de estrategias
      const page = await pagesAPI.getBySlug('/estrategias')
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        {/* Top tilted banner */}
        <div className="relative bg-[#0043ff] h-32 md:h-40 lg:h-48 transform skew-y-1 flex items-center justify-between px-6 md:px-12 lg:px-16 mt-16">
          <Link href="/" className="bg-[#0a0a1a]/10 backdrop-blur-sm border border-white/30 rounded-lg p-2 transform -skew-y-1 ml-1 z-20 -mt-36">
            <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/>
            </svg>
          </Link>
          <div className="text-left transform skew-y-1 -ml-16 md:-ml-8 lg:-ml-4">
            <h1 className="text-[35px] md:text-[45px] lg:text-[55px] font-black text-white leading-[119%] tracking-[0%]">
              Estrategias
            </h1>
            <h2 className="text-[35px] md:text-[45px] lg:text-[55px] font-black text-white leading-[119%] tracking-[0%]">
              de Crecimiento
            </h2>
          </div>
        ...
        {/* Main content */}
        <div className="px-6 md:px-12 lg:px-16 py-4 md:py-8 lg:py-12">
          {/* Title */}
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white text-center mb-3 md:mb-6">
            Elevamos tu negocio con un motor{' '}
            <span className="relative inline-block mx-2">
              <span className="relative z-10 text-[#FFEA1F] font-bold">
                {content.find(item => item.content_type === 'span')?.content || '360°'}
              </span>
              <svg 
          ...
          <div className="mb-6 md:mb-8 lg:mb-12">
            <p className="text-white text-sm md:text-base lg:text-lg leading-relaxed text-center max-w-2xl mx-auto">
              {content.find(item => item.content_type === 'paragraph')?.content || 'Desarrollamos el marco estratégico para tu proyecto, que servirá como hoja de ruta para el éxito.'}
            </p>
          </div>
          ...
          <div className="mt-8 md:mt-12 lg:mt-16">
            <div className="bg-[#0043ff] rounded-full px-6 md:px-8 py-2 mb-4 md:mb-6">
              <h2 className="text-white font-semibold text-center text-sm md:text-base">¿Qué entregamos?</h2>
            </div>
          ...
          {/* Process steps */}
          <div className="bg-[#0043FF] rounded-t-3xl p-6 md:p-8 lg:p-12 pb-32 mb-0 -mx-6 md:-mx-12 lg:-mx-16 mt-8 md:mt-12 lg:mt-16 relative">
          ...
          {/* Final CTA */}
          <div className="bg-[#030B46] rounded-t-3xl p-8 md:p-12 lg:p-16 -mx-6 md:-mx-12 lg:-mx-16 mb-0 -mt-8 relative z-20">
            <div className="text-left">
              {/* Main headline block */}
              <div className="mb-0">
                <div className="text-white font-medium text-[43.75px] md:text-[55px] lg:text-[65px] leading-[97%] tracking-[0%] mb-3 md:mb-6">
                  Eleva tu proyecto con una estrategia que{' '}
                  <span className="text-[#FFEA1F] relative inline-block font-extrabold text-[49px] md:text-[60px] lg:text-[70px]">
                    convierte
